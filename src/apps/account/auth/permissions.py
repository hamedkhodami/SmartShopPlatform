...
class IsStoreAdmin(BasePermissionCustom):
    user_role = UserRoleEnum.STORE_ADMIN


class IsCustomer(BasePermissionCustom):
...
class IsAdminOrStoreAdmin(BasePermissionAnyCustom):
    permission_classes_any = [IsAdmin, IsStoreAdmin]

    @classmethod
    def repr(cls):
        return "Admin or Store Admin"


class IsAdminOrCustomer(BasePermissionAnyCustom):
    permission_classes_any = [IsAdmin, IsCustomer]
...
class IsOwnerOrAdmin(BasePermissionAnyCustom):
    permission_classes_any = [IsAdmin]
